...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/langfuse v0.0.0-20251120140630-f9b6501229d9
	github.com/cloudwego/eino-ext/components/model/ark v0.1.47
	github.com/cloudwego/eino-ext/components/model/openai v0.1.5
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20251120140630-f9b6501229d9
	github.com/cloudwego/eino-ext/components/tool/mcp v0.0.7
	github.com/cloudwego/eino-ext/devops v0.1.8
	github.com/cloudwego/eino-ext/libs/acl/langfuse v0.0.0-20251120140630-f9b6501229d9
	...
	golang.org/x/telemetry/config v0.73.0
