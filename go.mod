...
require (
	...
	github.com/cloudwego/kitex/pkg/protocol/bthrift v0.0.0-20260622031501-d185a3050fb8
	...
	github.com/facebook/time v0.0.0-20260618092021-a88b641fcb50
	...
	golang.org/x/telemetry/config v0.105.0
