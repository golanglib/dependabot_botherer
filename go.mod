...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/langfuse v0.0.0-20251105133430-149843ccfe5d
	github.com/cloudwego/eino-ext/components/model/ark v0.1.41
	github.com/cloudwego/eino-ext/components/model/openai v0.1.4
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20251105133430-149843ccfe5d
	github.com/cloudwego/eino-ext/components/tool/mcp v0.0.6
	github.com/cloudwego/eino-ext/devops v0.1.8
	github.com/cloudwego/eino-ext/libs/acl/langfuse v0.0.0-20251105133430-149843ccfe5d
