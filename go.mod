...
require (
	...
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20260715135811-0910e2add6ed
	...
	github.com/facebook/time v0.0.0-20260710180950-7c55a6393ff7
	...
	golang.org/x/telemetry/config v0.110.0
