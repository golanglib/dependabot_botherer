...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/langfuse v0.0.0-20260424065505-3b3b8b5db0d0
	github.com/cloudwego/eino-ext/components/model/ark v0.1.67
	github.com/cloudwego/eino-ext/components/model/openai v0.1.13
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20260424065505-3b3b8b5db0d0
	github.com/cloudwego/eino-ext/components/tool/mcp v0.0.8
	github.com/cloudwego/eino-ext/devops v0.1.9
	github.com/cloudwego/eino-ext/libs/acl/langfuse v0.0.0-20260424065505-3b3b8b5db0d0
