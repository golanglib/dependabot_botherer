...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/langfuse v0.0.0-20260129022659-79f80daf11c9
	github.com/cloudwego/eino-ext/components/model/ark v0.1.63
	github.com/cloudwego/eino-ext/components/model/openai v0.1.8
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20260129022659-79f80daf11c9
	github.com/cloudwego/eino-ext/components/tool/mcp v0.0.8
	github.com/cloudwego/eino-ext/devops v0.1.8
	github.com/cloudwego/eino-ext/libs/acl/langfuse v0.0.0-20260129022659-79f80daf11c9
