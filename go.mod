...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/langfuse v0.0.0-20250818090953-a59b1be0df04
	...
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20250818090953-a59b1be0df04
	github.com/cloudwego/eino-ext/components/tool/mcp v0.0.3
	github.com/cloudwego/eino-ext/devops v0.1.8
	github.com/cloudwego/eino-ext/libs/acl/langfuse v0.0.0-20250818090953-a59b1be0df04
	github.com/cloudwego/eino-ext/libs/acl/openai v0.0.0-20250818090953-a59b1be0df04
	...
	golang.org/x/telemetry/config v0.61.0
