...
require (
	...
	github.com/cloudwego/eino-ext/components/retriever/volc_vikingdb v0.0.0-20260526040307-48c5fa20c59b
	...
	sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.35.0
